...
<html lang="ru">
<head>
    <title>НОВА — Сертификация и партнерство</title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="/css/libs/jquery.modal.css"/>

    <link rel="stylesheet" type="text/css" href="/css/style.css?v<?=filemtime("$root_server/css/style.css")?>" />
    <link rel="stylesheet" type="text/css" href="/css/media.css?v<?=filemtime("$root_server/css/media.css")?>" />

    <link rel="icon" href="/css/img/favicon-48.svg" />
    <link rel="apple-touch-icon" sizes="180x180" href="/css/img/favicon-180.svg" />
...
<body class="">
  ...
  <header class="header">
    <div class="container header__inner">
      <a href="/" class="logo">
        <img class="logo_desktop" src="/css/img/logo.svg" alt="НОВА" />
        <img class="logo_mobile" src="/css/img/logomob.svg" alt="НОВА" />
      </a>
      <nav class="nav">
        <ul class="nav__list">
          <li><a href="/pages/about/">О компании</a></li>
          <li class="nav-item--dropdown">
            <a href="/pages/categories/" class="nav-link--dropdown">Услуги <svg class="arrow-down" width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 1L7 7L13 1" stroke="" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg></a>
            <div class="dropdown-menu">
              <ul>
                <li><a href="/pages/pagecategories/">Сертификат пожарной безопасности <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 18L15 12L9 6" stroke="#184C43" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg></a></li>
                <li><a href="/pages/pagecategories/">Кабельные изделия <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 18L15 12L9 6" stroke="#184C43" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg></a></li>
                <li><a href="/pages/pagecategories/">Строительные и отделочные материалы <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 18L15 12L9 6" stroke="#184C43" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg></a></li>
                <li><a href="/pages/pagecategories/">Огнестойкие строительные конструкции и их заполнения <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 18L15 12L9 6" stroke="#184C43" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg></a></li>
                <li><a href="/pages/pagecategories/">Инженерное оборудование систем противодымной защиты <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 18L15 12L9 6" stroke="#184C43" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg></a></li>
                <li><a href="/pages/pagecategories/">Средства огнезащиты <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 18L15 12L9 6" stroke="#184C43" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg></a></li>
                <li><a href="/pages/pagecategories/">Сертификат соответствия ТР ЕАЭС 043/2017 <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 18L15 12L9 6" stroke="#184C43" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg></a></li>
              </ul>
            </div>
          </li>
          <li><a href="/pages/laboratory/">Лаборатория</a></li>
          <li><a href="/pages/clients/">Клиенты</a></li>
          <li><a href="/pages/licenses/">Лицензии</a></li>
...
<div class="mobile-menu">
  <div class="mobile-menu__header">
    <a href="/" class="logo">
      <img src="/css/img/logomob.svg" alt="НОВА" />
    </a>
