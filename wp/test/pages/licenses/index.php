  ...
  <section class="hero animate-on-scroll section_pt">
    ...
    <div class="container">
      <div class="hero__content hero__content_width">
        <h1>Лицензии</h1>
        <p>Аттестат аккредитации - документ, удостоверяющий аккредитацию юридического лица, индивидуального предпринимателя в качестве органа по сертификации, испытательной лаборатории (центра) в определенной области аккредитации.
        </p>
      </div>
